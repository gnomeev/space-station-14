...
namespace Content.Client.Options.UI
{
    ...
    public sealed partial class OptionsMenu : DefaultWindow
    {
        ...
        public OptionsMenu()
        {
            ...
            Tabs.SetTabTitle(4, Loc.GetString("ui-options-tab-network")); // 220 revert-network-tab
            Tabs.SetTabTitle(5 /* 220 revert-network-tab */, Loc.GetString("ui-options-tab-accessibility"));
            Tabs.SetTabTitle(6 /* 220 revert-network-tab */, Loc.GetString("ui-options-tab-admin"));
