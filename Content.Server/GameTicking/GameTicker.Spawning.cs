...
namespace Content.Server.GameTicking
{
    public sealed partial class GameTicker
    {
            ...
            bool silent = false)
        {
            ...
            var mobMaybe = _stationSpawning.SpawnPlayerCharacterOnStation(station, jobId, character, lateJoin: lateJoin);
        ...
        public void MakeJoinGame(ICommonSession player, EntityUid station, string? jobId = null, bool silent = false, bool latejoin = true)
        {
