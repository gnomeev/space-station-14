...
ghost-role-information-redwings-pilot-rules =
    Вы - [color=green][bold]Неантагонист[/bold][/color]. Поэтому вы не должны стремиться причинить вред станции и её экипажу.
    Вы пилот отряда Red Wings корпорации Interdyne Pharmaceutics - элитной группы платных боевых медиков.
    ...
    Управляйте шаттлом и обеспечивайте эвакуацию.
    Не покидайте шаттл без необходимости.
    Ваш главный приоритет - безопасная транспортировка команды и пациентов.
...
ghost-role-information-redwings-medic-rules =
    Вы - [color=green][bold]Неантагонист[/bold][/color]. Поэтому вы не должны стремиться причинить вред станции и её экипажу.
    Вы боевой парамедик отряда Red Wings корпорации Interdyne Pharmaceutics. Ваша задача - стабилизация и спасение клиентов компании в самых опасных условиях.
    Вы не помните ничего из своей предыдущей жизни и не помните ничего из того, что узнали, будучи призраком.
    Вам разрешено помнить знания об игре в целом, например, как готовить, как использовать предметы и т. д.
    Вам абсолютно [color=red]НЕ[/color] разрешено помнить, скажем, имя, внешность и т. д. вашего предыдущего персонажа.
    Ваши задачи: [color=red][bold]Избегайте ненужного боя[/bold][/color].
    Лечите и стабилизируйте пациентов.
    Работайте с командой для быстрой эвакуации.
...
ghost-role-information-redwings-officer-rules =
    Вы - [color=green][bold]Неантагонист[/bold][/color]. Поэтому вы не должны стремиться причинить вред станции и её экипажу.
    Вы офицер безопасности отряда Red Wings корпорации Interdyne Pharmaceutics - элитного подразделения боевых медиков. Вы координируете операцию и обеспечиваете безопасность команды.
    Вам разрешено помнить знания об игре в целом, например, как готовить, как использовать предметы и т. д.
    Вам абсолютно [color=red]НЕ[/color] разрешено помнить, скажем, имя, внешность и т. д. вашего предыдущего персонажа.
    Ваши задачи: [color=red][bold]Избегайте ненужного боя[/bold][/color].
    Руководите отрядом.
