...
bounty-item-ore-silver = Серебряння руда
...
bounty-description-ring = В этот ЭКСТРАОРДИНАРНЫЙ день состоится свадьба Соколовых, но Соколов потерял кольца, пришлите пару колец.
