...
ent-ComputerComms = консоль связи
    .desc = Консоль, используемая для подачи объявлений на всю станцию посредством клавиатуры или микрофона, изменения уровня угрозы и вызова эвакуационного шаттла.
...
ent-ComputerSalvageJobBoard = Консоль заданий по хламосборке
    .desc = консоль обеспечивающая доступ к хабу заданий хламсоборки, если вы не трусите конечно
