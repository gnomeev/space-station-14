...
ent-PaperWritten = { ent-Paper }
    .desc = { ent-Paper.desc }
ent-PaperSalvageJobLabel = Этикета доставки задания хламосборки
    .desc = Бумажная этикетка, обозначающая, что в ящике находится груз для выполнения задания хламосборки. Продав ящик с такой этикеткой, вы выполните задание.
