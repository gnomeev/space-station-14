...
ent-AirGrenade = Воздушная граната
    .desc =  Специальная твердотельная химическая граната, используемая для быстрого заполнения пространства стандартной воздушной смесью для дыхания. Заполняет до 30 плиток!
# Corvax-HiddenDesc-Start
