...
uplink-bulldog-desc = Компактный и злой: Содержит популярный дробовик Bulldog.

uplink-grenade-launcher-name = Чайна-Лейк

uplink-grenade-launcher-desc = Старый гранатомет China-Lake в комплекте с 5 снарядами противопехотных боеприпасов.

uplink-syndimov-law-name = Набор законов Синдимов

uplink-syndimov-law-desc = Подрывной набор законов, который используется, когда вы хотите переманить И.И. на свою сторону; используйте как можно чаще. Поставляется с ID Синдиката.

uplink-voice-mask-implanter-name = Имплантер маскировки личности

uplink-voice-mask-implanter-desc = Изменяет ваши голосовые связки и структуру лица, чтобы вы могли имитировать кого угодно, кого сможете представить.

uplink-bulldog-bundle-name = Набор "Бульдог"

uplink-bulldog-bundle-desc = Компактный и злой: Содержит популярный дробовик Bulldog, барабанный магазин со слагами 12 калибра и четыре барабанных магазина с картечью 12 калибра.

uplink-travel-camera-name = Туристическая камера

uplink-travel-camera-desc = Оглушайте людей своими навыками фотографии и удобно легальной вспышкой камеры. Заставляет вас выглядеть как турист.

uplink-briefcase-gun-name = Пушка-дипломат

uplink-briefcase-gun-desc = Неприметный дипломат с очень компактным C-20K, установленным внутри. Осторожнее, не сжимайте ручку слишком сильно!

uplink-energycrossbow-name = Мини-энергоарбалет

uplink-energycrossbow-desc = Оружие выбора любого оперативника, который предпочитает, чтобы его жертвы не двигались. Стреляет регенерирующимися токсичными стрелами, которые мгновенно валят жертв на пол.

uplink-hijack-beacon-name = Маяк угона

uplink-hijack-beacon-desc = Фирменный маяк угона Синдиката, разработанный для обхода межсетевых экранов Автоматизированных Торговых Станций марки Nanotrasen. Им требуется 200 секунд для срабатывания, и Торговые Станции объявят о том, что их взламывают, так что подготовьтесь соответственно.
